...
int main()
{
    ...
    float densidade1; // Armazenar a densidade carta 1
    float PIBPC1;   // Armazenar a PIB per Capita carta 1
    ...
    float densidade2; //  Armazenar a densidade carta 2
    float PIBPC2;   // Armazenar a PIB per Capita carta 1
    ...
    // Densidade Populacional é igual a população dividido pela área
    densidade1 = (float)(populacao1 / area1);
    densidade2 = (float)(populacao2 / area2);

    // PIB per Capita é igual a PIB dividido pela população
